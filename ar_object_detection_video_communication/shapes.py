...
class Text:
    ...
    def draw_text(self, frame):
        ...
        for word in self.text.split(' '):
            ...
            center_y += constants.Y_MULTI_WORD_ADJUSTER        
        return frame
        # return cv2.putText(frame, self.text, (self.coords.get('x'), self.coords.get('y')),
        #     cv2.FONT_HERSHEY_SIMPLEX, constants.FONT_SCALE, self.color, constants.TEXT_THICKNESS, cv2.LINE_AA)
